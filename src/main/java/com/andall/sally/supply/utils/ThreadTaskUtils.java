...
import com.andall.sally.supply.config.MdcThreadPoolTaskExecutor;
 ...
 * @Author: lsl
 * @Description:
 * @Date: Created on 16:57 2020/9/29
 */
public class ThreadTaskUtils {
    ...
    static {
        ...
        taskExecutor.setThreadNamePrefix("MdcThreadPoolTaskExecutor-");
        // 核心线程数
